    ...
    return (
        <Box sx={{ width: '100%' }}>
            < form onSubmit={handleSubmit(onSubmit)} >
                ...
                <TextField id="outlined-basic" fullWidth label="Password" variant="outlined" sx={{ marginBottom: 1 }} type="password"  {...register("password", { required: "Please enter your password" })} />
                <Typography variant="caption" display="block" gutterBottom sx={{ marginTop: '-5px', color: 'red' }}>
